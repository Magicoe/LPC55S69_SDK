...
- pin_list:
  ...
  - {pin_num: '14', peripheral: SYSCON, signal: CLKOUT, pin_signal: PIO0_16/ADC0_8/FC4_TXD_SCL_MISO_WS/CLKOUT/CT_INP4/SECURE_GPIO0_16, mode: inactive, slew_rate: standard,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin16_config = (/* Pin is configured as CLKOUT */
                                         IOCON_PIO_FUNC2 |
                                         ...
                                         IOCON_PIO_ASW_EN);
    /* PORT0 PIN16 (coords: 14) is configured as CLKOUT */
