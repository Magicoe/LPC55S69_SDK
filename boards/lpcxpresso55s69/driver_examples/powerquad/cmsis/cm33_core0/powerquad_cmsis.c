...
static void arm_cfft_q15Example(void)
{
    ...
    arm_cfft_instance_q15 instance = {.fftLen = CFFT_INPUT_LEN};
...
static void arm_ifft_q15Example(void)
{
    ...
    arm_cfft_instance_q15 instance = {.fftLen = IFFT_INPUT_LEN};
...
static void arm_ifft_q31Example(void)
{
    ...
    arm_cfft_instance_q31 instance = {.fftLen = IFFT_INPUT_LEN};
...
static void arm_dct4_q15Example(void)
{
    ...
    arm_cfft_radix4_instance_q15 cfftinstance = {.fftLen = DCT_INPUT_LEN};
...
static void arm_dct4_q31Example(void)
{
    ...
    arm_cfft_radix4_instance_q31 cfftinstance = {.fftLen = DCT_INPUT_LEN};
