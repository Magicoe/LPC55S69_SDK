...
static void PQ_Vector32InvFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_INV_INF)};

static void PQ_Vector32LnFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_LN_INF)};

static void PQ_Vector32SqrtFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_SQRT_INF)};

static void PQ_Vector32InvSqrtFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_ISQRT_INF)};

static void PQ_Vector32EtoxFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_ETOX_INF)};

static void PQ_Vector32EtonxFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_ETONX_INF)};

static void PQ_Vector32SinFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_SIN_INF)};

static void PQ_Vector32CosFP(float *pSrc, float *pDst){PQ_Primitive_Vector32(FP, PQ_COS_INF)};

static void PQ_Vector32InvFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_INV_INF)};

static void PQ_Vector32LnFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_LN_INF)};

static void PQ_Vector32SqrtFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_SQRT_INF)};

static void PQ_Vector32InvSqrtFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_ISQRT_INF)};

static void PQ_Vector32EtoxFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_ETOX_INF)};

static void PQ_Vector32EtonxFX(int32_t *pSrc, int32_t *pDst){PQ_Primitive_Vector32(FX, PQ_ETONX_INF)};
...
static void PQ_VectorSinFXExample(void)
{
    ...
    /* This is a workround for sin function, beacuse Niobe4 (LPC55xx) has a hardware bug
       on fixed point sin and cos opcodes. */
    PQ_VectorSinQ31(input, result, ARRAY_SIZE(input));
...
static void PQ_VectorCosFXExample(void)
{
    ...
    /* This is a workround for cos function, beacuse Niobe4 (LPC55xx) has a hardware bug
       on fixed point sin and cos opcodes. */
    PQ_VectorCosQ31(input, result, ARRAY_SIZE(input));
