...
When user presses a switch the PWM signal will be seen from Out 6
When user presses the switch again PWM signal on Out 6 will turn off
The PWM signal from Out 2 will remain active all the time
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
