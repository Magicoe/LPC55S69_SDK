...
- pin_list:
  ...
  - {pin_num: '61', peripheral: FLEXCOMM8, signal: LSPI_HS_SCK, pin_signal: PIO1_2/CTIMER0_MAT3/SCT_GPI6/LSPI_HS_SCK/USB1_PORTPWRN/PLU_OUT5, mode: pullUp, slew_rate: standard,
  ...
  - {pin_num: '62', peripheral: FLEXCOMM8, signal: LSPI_HS_MISO, pin_signal: PIO1_3/SCT0_OUT4/LSPI_HS_MISO/USB0_PORTPWRN/PLU_OUT6, mode: pullUp, slew_rate: standard,
    invert: disabled, digi_mode: digital, open_drain: disabled}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin1_config = (/* Pin is configured as LSPI_HS_SSEL1 */
                                        IOCON_PIO_FUNC5 |
                                        /* Selects pull-up function */
                                        IOCON_PIO_MODE_PULLUP |
                                        /* Standard mode, output slew rate control is enabled */
                                        ...
                                        /* Open drain is disabled */
                                        IOCON_PIO_OPENDRAIN_DI);
    /* PORT1 PIN1 (coords: 59) is configured as LSPI_HS_SSEL1 */
    ...
    const uint32_t port1_pin3_config = (/* Pin is configured as LSPI_HS_MISO */
                                        IOCON_PIO_FUNC6 |
                                        /* Selects pull-up function */
                                        IOCON_PIO_MODE_PULLUP |
                                        /* Standard mode, output slew rate control is enabled */
                                        ...
                                        /* Open drain is disabled */
                                        IOCON_PIO_OPENDRAIN_DI);
    /* PORT1 PIN3 (coords: 62) is configured as LSPI_HS_MISO */
