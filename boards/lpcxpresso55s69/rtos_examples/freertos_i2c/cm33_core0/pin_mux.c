...
- pin_list:
  ...
  - {pin_num: '71', peripheral: FLEXCOMM1, signal: CTS_SDA_SSEL0, pin_signal: PIO0_13/FC1_CTS_SDA_SSEL0/UTICK_CAP0/CT_INP0/SCT_GPI0/FC1_RXD_SDA_MOSI_DATA/PLU_IN0/SECURE_GPIO0_13,
    mode: inactive, slew_rate: standard, invert: disabled, digi_mode: digital, open_drain: disabled, ssel: signal3v3, filter_off: disabled, ecs: disabled, egp: i2c,
    i2cfilter: fastmode}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin13_config = (/* Pin is configured as FC1_CTS_SDA_SSEL0 */
                                         ...
                                         IOCON_PIO_I2CFILTER_FAST);
    /* PORT0 PIN13 (coords: 71) is configured as FC1_CTS_SDA_SSEL0 */
    ...
    const uint32_t port0_pin14_config = (/* Pin is configured as FC1_RTS_SCL_SSEL1 */
                                         ...
                                         /* I2C 50 ns glitch filter enabled */
                                         IOCON_PIO_I2CFILTER_FAST);
    /* PORT0 PIN14 (coords: 72) is configured as FC1_RTS_SCL_SSEL1 */
