...
typedef __cmse_nonsecure_call int (*rl_ept_rx_cb_ns_t)(void *payload, int payload_len, unsigned long src, void *priv);
#else
typedef int (*rl_ept_rx_cb_ns_t)(void *payload, int payload_len, unsigned long src, void *priv) __attribute__((cmse_nonsecure_call));
#endif
...
{
    unsigned long dst;  /*!< Remote endpoint address */
    char *data;         /*!< Payload buffer pointer */
    unsigned long size; /*!< Size of payload, in bytes */
};
 ...
 *
 */
struct rpmsg_lite_endpoint *rpmsg_lite_create_ept_nse(unsigned long addr,
 ...
 *
 */
int rpmsg_lite_destroy_ept_nse(struct rpmsg_lite_endpoint *rl_ept);
 ...
 *
 */
int rpmsg_lite_send_nse(struct rpmsg_lite_endpoint *ept,
