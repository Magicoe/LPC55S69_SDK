...
static int my_ept_read_cb_ns(void *payload, int payload_len, unsigned long src, void *priv)
{
...
int main(void)
{
    ...
    struct rpmsg_lite_endpoint_callback_descr_ns callback_descr_ns = {(rl_ept_rx_cb_ns_t)my_ept_read_cb_ns, &callback_data_ns};
    char str[50];
    ...
    rpmsg_lite_send_nse(my_ept_ns, &msg_params, RL_DONT_BLOCK);
