...
#define DATA_RAM_SIZE_NS            0x00028000
 ...
 *
 * Secure peripherals: SYSCON, IOCON, FLEXCOMM0, MAILBOX, CPU1
...
void BOARD_InitTrustZone()
{
    ...
    /* Set MAILBOX as secure */
    AHB_SECURE_CTRL->SEC_CTRL_AHB0_1_SLAVE_RULE = AHB_SECURE_CTRL_SEC_CTRL_AHB0_1_SLAVE_RULE_MAILBOX_RULE(0x3U);
    
    /* Set CPU1 as secure */
    AHB_SECURE_CTRL->MASTER_SEC_LEVEL = AHB_SECURE_CTRL_MASTER_SEC_LEVEL_MCM33C(0x3U) |
                                        AHB_SECURE_CTRL_MASTER_SEC_LEVEL_MCM33S(0x3U);
    AHB_SECURE_CTRL->MASTER_SEC_ANTI_POL_REG = AHB_SECURE_CTRL_MASTER_SEC_ANTI_POL_REG_MCM33C(0x0U) |
                                               AHB_SECURE_CTRL_MASTER_SEC_ANTI_POL_REG_MCM33S(0x0U);
