...
USB_DMA_NONINIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE) static uint8_t s_MouseBosHeadBuffer[USB_DESCRIPTOR_LENGTH_BOS_DESCRIPTOR]; /*!< use to receive bos descriptor head */
