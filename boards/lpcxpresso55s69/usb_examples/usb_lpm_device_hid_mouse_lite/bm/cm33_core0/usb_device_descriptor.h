...
#define USB_DEVICE_SPECIFIC_LPM_BCD_VERSION (0x0201U)
...
#define USB_DESCRIPTOR_LENGTH_STRING2 (sizeof(g_UsbDeviceString1))
#define USB_DESCRIPTOR_LENGTH_DEVICE_EXTENDED_CAPABILITY (7U)
#define USB_DESCRIPTOR_LENGTH_SS_DEVICE_CAPABILITY (10U)
#define USB_DESCRIPTOR_LENGTH_BOS_ALL (sizeof(USB_BOSDescriptor))
