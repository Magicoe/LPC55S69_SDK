...
WEAK void ACMP_CAPT0_IRQHandler(void);
...
void ACMP_CAPT0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    ACMP_CAPT0_IRQHandler,           // 40: ACMP and CAPT0 interrupts
    ...
    EZH_ARCH_B0_IRQHandler,          // 46: EZH_ARCH_B0
    ...
    PVTVF0_AMBER_IRQHandler,         // 76: PVT interrupts
    PVTVF0_RED_IRQHandler,           // 77: PVT interrupts
    PVTVF1_AMBER_IRQHandler,         // 78: PVT interrupts
    PVTVF1_RED_IRQHandler,           // 79: PVT interrupts
